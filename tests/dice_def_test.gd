...
func legacy_scene_content() -> String:
	var dice_shape_resource := (
		'[ext_resource type="Script" uid="uid://xsgh2gwr4gub" '
		+ 'path="res://addons/dice_roller/dice_shape.gd" id="2_qrebk"]'
	)
	var dice_def_resource := (
...
func test_scene_loading_shape_migration():
